...
void sort_quick(Graphisme *Graphisme, Array *arr, Status *status) { quicksort(Graphisme, arr, 0, arr->size - 1, status); }
...
void sort_merge(Graphisme *Graphisme, Array *arr, Status *status) { mergesort(Graphisme, arr, 0, arr->size - 1, status); }
